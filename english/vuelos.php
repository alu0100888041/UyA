...
<br><br><br>
	<div class="row">
		<form action="vuelosidavuelta.php">
			<button class="btn waves-effect waves-light col s2" type="submit" name="submit">Round trip
			</button>
		</form>
		<form action="vuelosida.php">
		    <button class="btn waves-effect waves-light col s2 offset-s1" type="submit" name="submit2">One way
		  	</button>
		  </form>
	</div>
</div>
